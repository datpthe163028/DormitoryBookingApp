...
public class BookingHistoryModel {
    ...
    public int userId;
    public String userName; // Assuming you want to include user name in DTO
    public Integer semesterId;
    public String semesterName; // Assuming you want to include semester name in DTO
    ...
    public Date semesterStartDate;
    public Date semesterEndDate;
